...
def write_rtdb_vars_h(variables):
    counter = 0
    os.makedirs('lib/rtdb', exist_ok=True)
...
def write_rtdb_c(variables, modules):
    with open('lib/rtdb/rtdb.cpp', 'w') as file:
        ...
        for var_type in at:
            ...
            file.write(f'    else if (rtdb_checkCrc32((void*) rtdb_arr_{var_type}[VarName], sizeof({var_type})))\n')
            file.write('    {\n')
            file.write('        // TODO\n')
            file.write('    }\n')
        ...
        for var_type in at:
            ...
            file.write(f'    {bt[var_type]} valToWrite = rtdb_arr_{var_type}[VarName]->{bt[var_type]}_val;\n')
            file.write(f'    // check CRC\n')
            file.write(f'    if (rtdb_checkCrc32( (void*) rtdb_arr_{var_type}[VarName], sizeof({var_type}))) // TODO\n')
            file.write('    {\n')
            file.write('        // TODO\n')
